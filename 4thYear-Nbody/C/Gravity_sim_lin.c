...
int main( int argc, char *argv[])
{
  ...
  int N_t = 200000; //atoi(argv[2]);            // Number of time ste100
  int t_save = 0;
  ...
  //Initialisng force arrays and position arrays to allow for the first iteration
  // of the loop to be correct
